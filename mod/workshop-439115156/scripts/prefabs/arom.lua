...
local function Retarget(inst)
    ...
    nil,
      {"musha","player","wall","houndmound","structure","companion","yamche","arongb","pig","bee","rocky","webber","bird","koalefant","beefalo","companion","moondrake","moondrake2","butterfly","prey","cavedweller","statue","character","abigail","smashable","veggie","catcoon","shadowminion"})
	end
end
...
inst.components.locomotor.runspeed = TUNING.BEEFALO_RUN_SPEED.DEFAULT * 0.5
	else
